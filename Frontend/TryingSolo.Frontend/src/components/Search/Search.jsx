...
const Search = ({HandleFilter, placeholder}) => {
    ...
    return (
        <section className={styles.search}>
                <div className={styles.searchInner} ref={innerSearch}>
                    ...
                    <input type="text" onChange={(e) => {HandleFilter(e)}} onFocus={() => setIsFocused(true)} onBlur={() => setIsFocused(false)} placeholder={placeholder} />
                </div>
            </section>
    )
}
